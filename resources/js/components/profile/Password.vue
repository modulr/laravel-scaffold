    ...
    <div class="row justify-content-md-center">
      <div class="col-md-9 col-xl-7">
        <div class="card-header px-0 mt-2 bg-transparent clearfix">
          <h4 class="float-left pt-2">Cambiar contraseña</h4>
          ...
          <form class="form-horizontal">
            <div class="form-group row justify-content-md-center">
              ...
              <div class="col-md-9">
                ...
                <small class="form-text text-muted">Escribe tu contraseña actual para cambiarla por una nueva</small>
                <div class="invalid-feedback" v-if="errors.current">{{errors.current[0]}}</div>
              </div>
            </div>
            <div class="form-group row justify-content-md-center">
              <label class="col-md-3">Nueva contraseña password</label>
              <div class="col-md-9">
            ...
            <div class="form-group row justify-content-md-center">
              <label class="col-md-3">Confirma la nueva contraseña</label>
              <div class="col-md-9">
