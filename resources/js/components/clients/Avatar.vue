<template>
  <div class="row justify-content-center mb-3">
    <div class="col-12 text-center">
      <img class="img-fluid" :src="user.avatar_url_banner" v-if="user.store">
      <img class="rounded-circle mb-2" style="width: 120px; height: 120px" :src="user.avatar_url_large" v-else>
